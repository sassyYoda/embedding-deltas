...
- **D-09:** Model is loaded via `open_clip.create_model_and_transforms('ViT-L-14', pretrained='openai')`. Exact call, no substitution. The QuickGELU variant is forced by the registry — verified against `open_clip_torch==3.3.0`. (Reference EMBD-01, research/STACK.md.)
